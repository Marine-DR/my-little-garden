...
import type { CatalogImportError } from '../shared/catalog.js';
...
function numericIssue(parameter: string): CatalogImportError {
  return issue(
    'invalid_number',
...
function headerErrors(header: readonly string[]): CatalogImportError[] {
